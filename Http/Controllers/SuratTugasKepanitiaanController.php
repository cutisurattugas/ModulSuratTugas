...
class SuratTugasKepanitiaanController extends Controller
{
    /**
    ...
    public function index()
    {
        $kepanitiaans = DB::table('kepanitiaans')
            ->join('pegawais', 'kepanitiaans.pimpinan_username', '=', 'pegawais.username')
            ->get();
        return view('surattugas::kepanitiaan.index', [
